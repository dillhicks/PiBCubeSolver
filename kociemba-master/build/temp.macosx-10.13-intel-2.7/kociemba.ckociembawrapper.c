...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 1), // char *()(char *, char *, char *)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 5), // char *
...
static char * _cffi_d_solve(char * x0, char * x1, char * x2)
{
  return solve(x0, x1, x2);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_solve(PyObject *self, PyObject *args)
{
  ...
  if (!PyArg_UnpackTuple(args, "solve", 3, 3, &arg0, &arg1, &arg2))
    return NULL;
